...
// FUTURE GOOGLE DRIVE IMAGE TIP: Google Drive images can be added using the direct format:
// "https://lh3.googleusercontent.com/d/YOUR_FILE_ID" (e.g. "https://lh3.googleusercontent.com/d/1QfykkJL0aRY2wTc4YrC...")
const projectPictures = {
  "student-mgmt": [
    "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=500&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?w=500&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=500&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=500&auto=format&fit=crop",
  ...
  "portfolio-web": [
    ...
    "https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=500&auto=format&fit=crop",
  ...
  "ai-chat": [] // Future photo uploads are fully supported here using standard or Google Drive direct image URLs (Point 3)
};
...
projectCards.forEach((card) => {
  card.addEventListener("click", (e) => {
    ...
    // Check if the project has pictures (checks array existence & length)
    if (!projectPictures[projectKey] || projectPictures[projectKey].length === 0) {
